...
const Messages = (() => {
    ...
    async function handleSubmit(e) {
        ...
        if (email && !validateEmail(email)) return showFormError('E-mail inválido.');

        const whatsappClean = whatsapp ? cleanWhatsapp(whatsapp) : '';
        if (whatsapp && !whatsappClean) return showFormError('WhatsApp inválido.');
